...
const engineeringLspTargetSelectionPanel = document.querySelector("#engineering-lsp-target-selection-panel");
const engineeringLspTargetSelect = document.querySelector("#engineering-lsp-target-select");
const engineeringLspTargetSelectionStatus = document.querySelector("#engineering-lsp-target-selection-status");
...
const acpxCodexBridgeLiveBoundary = document.querySelector("#acpx-codex-bridge-live-boundary");
