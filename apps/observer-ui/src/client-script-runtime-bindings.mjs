...
engineeringLspSourceTransferTaskButton.addEventListener("click", () => {
  createEngineeringLspSourceTransferLoopTask().catch((error) => {
    setControlMessage(\`Request failed: \${formatError(error)}\`);
  });
});
...
engineeringLoopSelectedTargetReadButton.addEventListener("click", () => {
  readEngineeringLoopSelectedTarget().catch((error) => {
    setControlMessage(\`Request failed: \${formatError(error)}\`);
  });
});
...
acpxCodexBridgeWrapperWriteTaskButton.addEventListener("click", () => {
  createAcpxCodexBridgeWrapperWriteApprovalTask().catch((error) => {
    setControlMessage(\`Request failed: \${formatError(error)}\`);
  });
});
...
operatorScheduleArmButton.addEventListener("click", () => {
  scheduleOperatorRunFromUi().catch((error) => {
    setControlMessage("Request failed: " + formatError(error));
  });
});

operatorScheduleRearmButton.addEventListener("click", () => {
  rearmOperatorScheduleFromUi().catch((error) => {
    setControlMessage("Request failed: " + formatError(error));
  });
});

operatorScheduleCancelButton.addEventListener("click", () => {
  cancelOperatorScheduleFromUi().catch((error) => {
    setControlMessage("Request failed: " + formatError(error));
  });
});

operatorScheduleRefreshButton.addEventListener("click", () => {
  refreshOperatorSchedule().catch((error) => {
    setControlMessage("Request failed: " + formatError(error));
  });
});
...
startTrustedSidecarProbeButton.addEventListener("click", () => {
  startTrustedSidecarLifecycleProbe().catch((error) => {
    setControlMessage(\`Request failed: \${formatError(error)}\`);
  });
});
