...
const browserPagePreviewTab = document.querySelector("#browser-page-preview-tab");
const aiWorkspacePreviewTab = document.querySelector("#ai-workspace-preview-tab");
const browserPagePreview = document.querySelector("#browser-page-preview");
const aiWorkspacePreview = document.querySelector("#ai-workspace-preview");
const aiWorkspaceProjectionStatus = document.querySelector("#ai-workspace-projection-status");
const aiWorkspaceProjectionFrame = document.querySelector("#ai-workspace-projection-frame");
const aiWorkspaceOperatorClickToggle = document.querySelector("#ai-workspace-operator-click-toggle");
const aiWorkspaceOperatorClickStatus = document.querySelector("#ai-workspace-operator-click-status");
const aiWorkspaceOperatorTypeInput = document.querySelector("#ai-workspace-operator-type-input");
const aiWorkspaceOperatorTypeButton = document.querySelector("#ai-workspace-operator-type-button");
const aiWorkspaceOperatorTypeStatus = document.querySelector("#ai-workspace-operator-type-status");
const screenSemanticTargetSelect = document.querySelector("#screen-semantic-target-select");
const createSemanticClickTaskButton = document.querySelector("#create-semantic-click-task-button");
const screenSemanticTargetTaskJson = document.querySelector("#screen-semantic-target-task-json");
...
const systemdUnitMemoryCurrent = document.querySelector("#systemd-unit-memory-current");
const systemdUnitMemoryPeak = document.querySelector("#systemd-unit-memory-peak");
const systemdUnitTasksCurrent = document.querySelector("#systemd-unit-tasks-current");
const systemdUnitResourceStatus = document.querySelector("#systemd-unit-resource-status");
const systemdUnitResourceWarnings = document.querySelector("#systemd-unit-resource-warnings");
...
const systemdJournalEvidenceAvailable = document.querySelector("#systemd-journal-evidence-available");
const systemdJournalEvidenceCount = document.querySelector("#systemd-journal-evidence-count");
const systemdJournalEvidenceMode = document.querySelector("#systemd-journal-evidence-mode");
const systemdJournalEvidenceUnit = document.querySelector("#systemd-journal-evidence-unit");
const systemdJournalEvidenceLines = document.querySelector("#systemd-journal-evidence-lines");
const refreshSystemdJournalEvidenceButton = document.querySelector("#refresh-systemd-journal-evidence-button");
const systemdJournalEvidenceJson = document.querySelector("#systemd-journal-evidence-json");
const systemdBootEvidenceCurrent = document.querySelector("#systemd-boot-evidence-current");
const systemdBootEvidencePrevious = document.querySelector("#systemd-boot-evidence-previous");
const systemdBootEvidenceAssessment = document.querySelector("#systemd-boot-evidence-assessment");
const systemdBootEvidenceMode = document.querySelector("#systemd-boot-evidence-mode");
const refreshSystemdBootEvidenceButton = document.querySelector("#refresh-systemd-boot-evidence-button");
const systemdBootEvidenceJson = document.querySelector("#systemd-boot-evidence-json");
...
const aiNativeIntakeStatus = document.querySelector("#ai-native-intake-status");
const aiNativeIntakeSurface = document.querySelector("#ai-native-intake-surface");
const startAiNativeIntakeButton = document.querySelector("#start-ai-native-intake-button");
const stopAiNativeIntakeButton = document.querySelector("#stop-ai-native-intake-button");
...
const runAiWorkspaceLocalOcrButton = document.querySelector("#run-ai-workspace-local-ocr-button");
const aiWorkspaceLocalOcrStatus = document.querySelector("#ai-workspace-local-ocr-status");
const aiWorkspaceLocalOcrOutput = document.querySelector("#ai-workspace-local-ocr-output");
const ocrAssessAiWorkspaceButton = document.querySelector("#ocr-assess-ai-workspace-button");
const aiWorkspaceOcrAssessmentStatus = document.querySelector("#ai-workspace-ocr-assessment-status");
const ocrClickAiWorkspaceButton = document.querySelector("#ocr-click-ai-workspace-button");
const aiWorkspaceOcrClickStatus = document.querySelector("#ai-workspace-ocr-click-status");
const ocrTypeAiWorkspaceButton = document.querySelector("#ocr-type-ai-workspace-button");
const aiWorkspaceOcrTypeStatus = document.querySelector("#ai-workspace-ocr-type-status");
const ocrFocusTypeAiWorkspaceButton = document.querySelector("#ocr-focus-type-ai-workspace-button");
const aiWorkspaceOcrFocusTypeStatus = document.querySelector("#ai-workspace-ocr-focus-type-status");
const runAiWorkspaceSingleStepButton = document.querySelector("#run-ai-workspace-single-step-button");
const runAiWorkspaceSemanticSubmitButton = document.querySelector("#run-ai-workspace-semantic-submit-button");
const aiWorkspaceSemanticSubmitStatus = document.querySelector("#ai-workspace-semantic-submit-status");
const runAiWorkspaceSemanticFormWorkflowButton = document.querySelector("#run-ai-workspace-semantic-form-workflow-button");
const aiWorkspaceSemanticFormWorkflowStatus = document.querySelector("#ai-workspace-semantic-form-workflow-status");
const runAiWorkspaceNativeIntakeWorkflowButton = document.querySelector("#run-ai-workspace-native-intake-workflow-button");
const aiWorkspaceNativeIntakeWorkflowStatus = document.querySelector("#ai-workspace-native-intake-workflow-status");
const runAiWorkspaceReviewedMultiApplicationMissionButton = document.querySelector("#run-ai-workspace-reviewed-multi-application-mission-button");
const aiWorkspaceReviewedMultiApplicationMissionStatus = document.querySelector("#ai-workspace-reviewed-multi-application-mission-status");
const runAiWorkspaceBoundedRunButton = document.querySelector("#run-ai-workspace-bounded-run-button");
const runAiWorkspaceReviewedCycleButton = document.querySelector("#run-ai-workspace-reviewed-cycle-button");
...
const aiWorkspaceReviewedCycleStatus = document.querySelector("#ai-workspace-reviewed-cycle-status");
