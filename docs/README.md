...
| [OPENCLAW_NIX_STORE_RUNTIME_PACKAGING_PLAN.md](./plans/OPENCLAW_NIX_STORE_RUNTIME_PACKAGING_PLAN.md) | Active kernel-whitepaper Phase A route; event-hub, screen-sense, and screen-act are store-native (3/9), with system-heal next. |
