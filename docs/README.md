...
| [OPENCLAW_DBUS_NATIVE_SYSTEMD_CONTROL_PLAN.md](./plans/OPENCLAW_DBUS_NATIVE_SYSTEMD_CONTROL_PLAN.md) | Active Phase B route; native inventory is complete and fixed-unit Polkit/D-Bus restart is implemented, awaiting switched-VM mutation/recovery proof. |
