...
| [OPENCLAW_TRUSTED_WORK_VIEW_SESSION_CONTRACT_PLAN.md](./plans/OPENCLAW_TRUSTED_WORK_VIEW_SESSION_CONTRACT_PLAN.md) | Active Level 2 bridge with real Firefox, semantic inventory/click, autonomous selection, write-only input evidence, and the next frame-bound semantic type slice. |
