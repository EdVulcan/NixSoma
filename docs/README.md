...
| [OPENCLAW_NIX_STORE_RUNTIME_PACKAGING_PLAN.md](./plans/OPENCLAW_NIX_STORE_RUNTIME_PACKAGING_PLAN.md) | Active kernel-whitepaper Phase A route; event-hub and screen-sense are store-native (2/9), with screen-act next. |
