...
| [OPENCLAW_NIX_STORE_RUNTIME_PACKAGING_PLAN.md](./plans/OPENCLAW_NIX_STORE_RUNTIME_PACKAGING_PLAN.md) | Active kernel-whitepaper Phase A route; seven services are store-native (7/9), with browser-runtime next. |
