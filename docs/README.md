...
| [OPENCLAW_NIX_STORE_RUNTIME_PACKAGING_PLAN.md](./plans/OPENCLAW_NIX_STORE_RUNTIME_PACKAGING_PLAN.md) | Active kernel-whitepaper Phase A route; eight services are store-native (8/9), with core as the final closure. |
