...
| [OPENCLAW_TRUSTED_WORK_VIEW_SESSION_CONTRACT_PLAN.md](./plans/OPENCLAW_TRUSTED_WORK_VIEW_SESSION_CONTRACT_PLAN.md) | Active Level 1 to Level 2 bridge with a session-manager owned in-process helper lease matched by browser-runtime and propagated through screen-sense, core, and Observer state. |
