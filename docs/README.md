...
| [OPENCLAW_DBUS_NATIVE_SYSTEMD_CONTROL_PLAN.md](./plans/OPENCLAW_DBUS_NATIVE_SYSTEMD_CONTROL_PLAN.md) | Active Phase B route; begin with native read-only systemd D-Bus inventory before any privileged mutation or Polkit work. |
