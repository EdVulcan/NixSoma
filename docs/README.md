...
| [OPENCLAW_DBUS_NATIVE_SYSTEMD_CONTROL_PLAN.md](./plans/OPENCLAW_DBUS_NATIVE_SYSTEMD_CONTROL_PLAN.md) | Completed Phase B fixed-unit slice: native inventory, approved Polkit/D-Bus system-sense restart, and kernel peer-identity verification have real core and Observer VM proof. |
