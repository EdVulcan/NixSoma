...
| [OPENCLAW_PHASE_C_KERNEL_PROCESS_EXEC_PLAN.md](./plans/OPENCLAW_PHASE_C_KERNEL_PROCESS_EXEC_PLAN.md) | Active first Phase C slice: bounded read-only eBPF `sched_process_exec` capture through system-sense, core proxy, and Observer. |
