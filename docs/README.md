...
| [OPENCLAW_TRUSTED_WORK_VIEW_SESSION_CONTRACT_PLAN.md](./plans/OPENCLAW_TRUSTED_WORK_VIEW_SESSION_CONTRACT_PLAN.md) | Active Level 2 bridge with systemd user ownership, real NixOS Firefox, bounded visual capture, frame-grounded actions, and the next semantic-target inventory slice. |
