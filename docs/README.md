...
| [OPENCLAW_NATIVE_ACPX_CODEX_BRIDGE_COMPATIBILITY_PLAN.md](./plans/OPENCLAW_NATIVE_ACPX_CODEX_BRIDGE_COMPATIBILITY_PLAN.md) | Active ACPX/Codex bridge compatibility and session metadata persistence route without reading credentials, writing wrappers, spawning ACP processes, or using provider egress. |
