...
That should approve and run the recovered verification task through the existing
operator path, then prove successful rerun verification evidence and recovery
readback without automatic approval or recovery execution.
