...
capability is to include a small bounded matching-target pattern summary in the
same explicitly approved incident handoff. Real generation activation, rollback,
