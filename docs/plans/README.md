...
| [`OPENCLAW_RENEWABLE_OPERATOR_MISSION_PLAN.md`](./OPENCLAW_RENEWABLE_OPERATOR_MISSION_PLAN.md) | Renewable finite mission epochs over the existing bounded window owner, with checkpoint-before-execution, explicit renewal, pause/cancel, restart re-arm, circuit break, and Observer progress. |
