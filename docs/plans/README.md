...
verification, local context packet, Level 2 work-view observation, and explicit
work-view control handoff bridges through the common capability runtime are
documented in:
