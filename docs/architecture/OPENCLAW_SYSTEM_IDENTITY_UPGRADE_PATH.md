...
| Level 2 受信会话组件 | 约 90% | trusted-session 契约、takeover suspend/resume-rebind、sidecar lifecycle/fail-closed recovery、持续 bounded capture、fresh-capture 门禁、sidecar IPC browser input/click/new-tab transport、autonomous task dispatch、bounded capture-interruption retry，以及 session-manager/browser-runtime restart recovery 已有；active-task session-authority restart continuity 和更稳定图形 runtime 尚未落地。 |
