...
| Level 2 受信会话组件 | 约 40% | trusted-session 契约、身份一致性、session-manager in-process helper lease、work-view recovery/readback 已有；lease 约束的 action mediation、外部 sidecar 和更稳定 capture runtime 尚未落地。 |
