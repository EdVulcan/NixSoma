...
import { createCredentialLocalReadResultEnvelopeCreationExecutionAttemptLocalReadResultEnvelopeCreationExecutionAttemptRuntime } from "../src/cloud-provider-credential-local-read-result-envelope-attempt.mjs";
