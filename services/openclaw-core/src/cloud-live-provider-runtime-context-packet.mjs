...
function compactPacketEvidence(packet, {
  ...
  return {
    ...
    semanticActionDecisionStatus: packet.summary?.semanticActionDecisionStatus ?? null,
    semanticActionDecisionReason: packet.summary?.semanticActionDecisionReason ?? null,
    semanticActionReady: packet.summary?.semanticActionReady === true,
    ...
    experienceMemoryMatched: packet.summary?.experienceMemoryMatched ?? 0,
    experienceMemoryCompletedMatches: packet.summary?.experienceMemoryCompletedMatches ?? 0,
    experienceMemoryFailedMatches: packet.summary?.experienceMemoryFailedMatches ?? 0,
    experienceMemoryCompletionRate: packet.summary?.experienceMemoryCompletionRate ?? null,
    experienceMemoryLatestOutcome: packet.summary?.experienceMemoryLatestOutcome ?? null,
