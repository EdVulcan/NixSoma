export function buildBaseCapabilities({
  ...
  return [
    ...
    {
      id: "sense.ai.workspace.local_ocr",
      name: "AI Workspace Local OCR",
      kind: "sensor",
      service: "openclaw-core",
      endpoint: `http://${host}:${port}/capabilities/invoke`,
      intents: ["ai.workspace.local_ocr"],
      domains: ["user_task"],
      risk: "medium",
      governance: "audit_only",
    ...
    {
      id: "act.ai.workspace.ocr_type",
      name: "AI Workspace OCR Type",
      kind: "actuator",
      service: "openclaw-core",
      endpoint: `http://${host}:${port}/capabilities/invoke`,
      intents: ["ai.workspace.ocr_type"],
      domains: ["cross_boundary"],
      risk: "medium",
      governance: "standing_authorization",
    ...
    {
      id: "act.ai.workspace.native_intake_workflow",
      name: "AI Workspace Native Intake Workflow",
      kind: "actuator",
      service: "openclaw-core",
      endpoint: `http://${host}:${port}/capabilities/invoke`,
      intents: ["ai.workspace.native_intake_workflow"],
      domains: ["cross_boundary"],
      risk: "medium",
      governance: "standing_authorization",
    ...
    },
    {
      ...
      service: "openclaw-core",
      endpoint: `http://${host}:${port}/capabilities/invoke`,
      intents: ["ai.workspace.bounded_run"],
      domains: ["cross_boundary"],
      risk: "medium",
      governance: "standing_authorization",
    ...
    },
    {
      ...
      risk: "high",
      governance: "allow",
      description: "Create an explicitly confirmed, request-bound DeepSeek handoff task through the existing approval owner without contacting the endpoint or reading credentials; the created task remains approval-gated.",
    },
    {
    ...
    },
    {
      ...
      risk: "high",
      governance: "allow",
      description: "Create approval-gated native tasks for bounded OpenClaw workspace text writes using the existing filesystem write capability and ledger; this capability does not perform the write.",
    },
    {
      ...
      risk: "high",
      governance: "allow",
      description: "Create approval-gated native tasks for bounded OpenClaw workspace patch application with diff preview, using the existing filesystem write capability and ledger; this capability does not apply the patch.",
    },
    {
    ...
    {
      id: "act.openclaw.declarative_evolution.activation_decision",
      name: "Declarative Evolution Activation Decision",
      kind: "actuator",
      service: "openclaw-core",
      endpoint: `http://${host}:${port}/plugins/native-adapter/declarative-evolution/activation-decisions`,
      intents: [
        "openclaw.declarative_evolution.activation_decision",
        "declarative.evolution.activation_decision",
        "nix.managed_config_activation_decision",
      ],
      domains: ["body_internal"],
      risk: "high",
      governance: "allow",
    ...
    },
    {
      ...
      risk: "high",
      governance: "allow",
      description: "Create an explicitly confirmed activation task that binds an approved decision to the fixed hostd owner and independent post-activation health oracle.",
    },
    {
      id: "act.openclaw.declarative_evolution.rollback",
      name: "Fixed Declarative Evolution Rollback",
      kind: "actuator",
      service: "openclaw-core",
      endpoint: `http://${host}:${port}/plugins/native-adapter/declarative-evolution/rollback-tasks`,
      intents: [
        "openclaw.declarative_evolution.rollback",
        "declarative.evolution.rollback",
        "nix.managed_config_rollback",
      ],
      domains: ["body_internal"],
      risk: "high",
      governance: "allow",
      description: "Create an explicitly confirmed rollback task bound to one verified activation receipt, its root-only single-use snapshot, the exact previous generation, and independent post-rollback health.",
    },
    {
