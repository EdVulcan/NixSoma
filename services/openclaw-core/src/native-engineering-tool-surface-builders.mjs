...
export const NATIVE_ENGINEERING_TOOL_CONTRACTS = [
  {
    ...
    approvalExpectation: "not_required_for_bounded_content_reads; workspace scope, budget, and audit remain required",
    ...
    migrationStatus: "absorbed_bounded_route_and_capability_runtime",
    deferredExecutionBoundary: "this inventory returns no file body; bounded native read and capability-runtime invocation own content reads",
  ...
  },
  {
    ...
    migrationStatus: "absorbed_bounded_route_and_capability_runtime",
    deferredExecutionBoundary: "this inventory executes no glob; bounded native path search and capability-runtime invocation own workspace discovery",
  ...
  },
  {
    ...
    migrationStatus: "absorbed_bounded_route_and_capability_runtime",
    deferredExecutionBoundary: "this inventory executes no grep; bounded native content search and capability-runtime invocation own workspace search",
    expectedSourcePaths: ["extensions/cc-tools/src/tools/GrepTool.ts"],
  },
  {
    sourceToolName: "cc_lsp",
    intendedNativeCapabilityId: "sense.openclaw.engineering_tool.lsp_evidence / act.openclaw.engineering_tool.lsp_lifecycle_task / sense.openclaw.engineering_tool.lsp_lifecycle_state / sense.openclaw.engineering_tool.lsp_selected_target_read_bridge / plan.openclaw.engineering_tool.lsp_selected_target_edit_proposal_seed",
    operationClass: "language_intelligence_evidence_governed_lifecycle_state_read_bridge_and_edit_seed",
    riskLevel: "medium",
    domain: "workspace_engineering",
    approvalExpectation: "not_required_for_evidence_state_readback_selected_target_read_bridge_or_edit_seed; lifecycle/source-transfer/symbol execution and edit mutation require explicit approval",
    auditExpectation: "record language, server binary, workspace, request kind, lifecycle state, bounded target metadata, selected-target read bridge, edit proposal seed, and failure evidence",
    observerVisibilityExpectation: "show server availability, lifecycle state, definition/reference/hover request evidence, selected target, read bridge route, edit seed route, and shutdown status",
    migrationStatus: "partially_absorbed_lifecycle_state_readback_symbol_request_target_selection_read_bridge_and_edit_seed",
  ...
  function buildNativeEngineeringToolSurfaceInventory({ workspacePath = null } = {}) {
    ...
    return {
      ...
      deferredExecutionBoundaries: [
        ...
        "no unbounded raw file read outside the native bounded read/search surface",
        "no unbounded glob or grep execution outside the native bounded read/search surface",
