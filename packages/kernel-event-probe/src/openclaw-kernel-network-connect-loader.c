...
static int handle_event(void *raw_context, void *raw_data, size_t data_size) {
  ...
  const struct openclaw_network_connect_event *event = raw_data;
  ...
  printf(",\"family\":%u,\"addressLength\":%u}\n",
    event->family,
...
int main(int argc, char **argv) {
  ...
  program = bpf_object__find_program_by_name(object, "record_network_connect");
