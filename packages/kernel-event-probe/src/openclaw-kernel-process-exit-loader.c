...
struct openclaw_process_exit_event {
...
static int handle_event(void *raw_context, void *raw_data, size_t data_size) {
  ...
  const struct openclaw_process_exit_event *event = raw_data;
...
int main(int argc, char **argv) {
  ...
  program = bpf_object__find_program_by_name(object, "record_process_exit");
