...
if (( START_PHASE < 99 || END_PHASE > 127 || START_PHASE > END_PHASE )); then
  echo "Result-envelope batch phase range must be within 99..127 and non-empty: $START_PHASE..$END_PHASE" >&2
  exit 1
fi
