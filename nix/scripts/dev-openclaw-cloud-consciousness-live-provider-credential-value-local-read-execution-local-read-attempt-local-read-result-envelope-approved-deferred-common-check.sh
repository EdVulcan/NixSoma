...
openclaw_result_envelope_prepare_prereq_state \
  ...
  "PHASE100_PORT_BASE" \
  "dev-openclaw-cloud-consciousness-live-provider-credential-value-local-read-execution-local-read-attempt-local-read-result-envelope-task-shell-common-check.sh"
