...
function selectSourceHeuristics(file) {
  const direct = new Map([
    ...
    ["nix/packages/openclaw-core.nix", ["body-config"]],
    ["nix/packages/openclaw-hostd.nix", ["body-config"]],
    ...
    ["packages/shared-systemd/src/openclaw-hostd-capabilities.json", ["body-config", "openclaw-systemd-next-repair-real-execution", "observer-openclaw-systemd-next-repair-real-execution"]],
