...
function selectSourceHeuristics(file) {
  const direct = new Map([
    ...
    ["apps/observer-ui/src/client-script-config-dom-system-body.mjs", ["observer-capability-invoke", "observer-openclaw-ai-work-view-capture", "observer-openclaw-systemd-next-repair-task-shell"]],
    ["apps/observer-ui/src/client-script-runtime-system-body-tasks.mjs", ["observer-openclaw-systemd-next-repair-task-shell"]],
    ["apps/observer-ui/src/observer-panels-system.mjs", ["observer-openclaw-systemd-next-repair-task-shell"]],
    ...
    ["services/openclaw-core/src/core-infrastructure-routes.mjs", ["openclaw-kernel-network-connect-capture"]],
    ...
    ["nix/packages/openclaw-system-sense.nix", ["body-config", "openclaw-kernel-process-exec-capture", "observer-openclaw-kernel-process-exec-capture", "openclaw-kernel-network-connect-capture", "observer-openclaw-kernel-network-connect-capture"]],
    ["nix/packages/observer-ui.nix", ["body-config", "observer-openclaw-kernel-process-exec-capture", "observer-openclaw-kernel-network-connect-capture"]],
