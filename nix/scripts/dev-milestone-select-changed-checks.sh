...
function selectSourceHeuristics(file) {
  const direct = new Map([
    ...
    ["services/openclaw-core/src/plan-builder.mjs", ["openclaw-core-service-unit-tests", "capability-invoke", "observer-capability-invoke", "openclaw-native-plugin-runtime-refresh-evidence", "observer-openclaw-native-plugin-runtime-refresh-evidence"]],
    ...
    ["apps/observer-ui/src/observer-panels-operations.mjs", [nativeEngineeringLspObserverCheck, "observer-capability-invoke"]],
