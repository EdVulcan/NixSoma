...
function selectSourceHeuristics(file) {
  const direct = new Map([
    ...
    ["nix/modules/openclaw-body.nix", ["body-config", "openclaw-kernel-process-exec-capture", "observer-openclaw-kernel-process-exec-capture", nativeDeclarativeEvolutionCoreCheck, nativeDeclarativeEvolutionObserverCheck]],
