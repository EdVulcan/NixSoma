...
mkOpenClawNpmRuntimeClosure {
  ...
  files = [
    ...
    ../../services/openclaw-system-sense/src/kernel-network-connect-capture.mjs
    ...
    ../../services/openclaw-system-sense/src/systemd-resource-observation.mjs
    ../../services/openclaw-system-sense/src/systemd-resource-trend.mjs
    ...
    ../../services/openclaw-system-sense/src/systemd-journal-evidence.mjs
    ../../services/openclaw-system-sense/src/systemd-boot-evidence.mjs
